// C++ program to print all triplets in given C++ program to print all triplets in given array that form Arithmetic Progression array that form Arithmetic Progression
#include <bits/stdc++.h>
using namespace std;
